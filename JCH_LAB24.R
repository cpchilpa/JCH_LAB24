...
genes <- as.matrix(
  read.csv("C:\\Users\\HP\\Documents\\CIENCIA DE DATOS\\LAB 24 DATOS\\LAB24\\LAB24\\heatmap_data.csv",
           sep = "," ,
           header = T,
           row.names = 1))

annotation_col <- read.csv("C:\\Users\\HP\\Documents\\CIENCIA DE DATOS\\LAB 24 DATOS\\LAB24\\LAB24\\annotation_col.csv", header = T,
           row.names = 1)

annotation_row <- read.csv("C:\\Users\\HP\\Documents\\CIENCIA DE DATOS\\LAB 24 DATOS\\LAB24\\LAB24\\annotation_row.csv", header = T,
                           row.names = 1)
